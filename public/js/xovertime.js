...
// $(document).on('click', '#end_time', function () { 
//     // a = $( "#start_time option:selected" ).val()
//     var start = $("#start_time option:selected" ).val().split(":");
//     var end = $("#end_time option:selected" ).val().split(":");
...
//      var a = moment().set({hour: start[0], minute: start[1], second: 0, millisecond: 0}).toDate();
//      var b = moment().set({hour: end[0], minute: end[1], second: 0, millisecond: 0}).toDate();
//     // var b =  moment().format('hh:mm:ss');
