@extends('layouts.moa_main')
    ...
    @section('title')
        <title>MOA | Marital Status</title>
    @endsection
                        ...
                        <div class="iq-card">
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="user-list-table" class="table table-hover table-bordered mt-4" role="grid" aria-describedby="user-list-page-info">
                                    ...
                                    <tbody>
                                            ...
                                            @foreach($marital_data as $key => $marital)
                                                <tr>
                                                    <td>{{ $marital_data->firstItem() + $key }}</td>
                                                    <td>{{ ucfirst($marital -> name)}}</td>
                                                    <td>{{ ($marital -> Description)}}</td>
                                                    <td>
                            ...
                            <div class="row justify-content-between mt-3">
                                <div id="user-list-page-info" class="col-md-6">
                                    <span>Showing {{$marital_data->firstItem()}} to {{$marital_data->lastItem()}}  of {{ $marital_data->total()}} entries</span>
                                </div>
                                <div class="col-md-6">
