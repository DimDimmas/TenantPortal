                        ...
                        <div class="iq-card">
                            ...
                            <div class="row justify-content-between mt-3">
                                <div id="user-list-page-info" class="col-md-6">
                                    <span>Showing {{$department_data->firstItem()}} to {{$department_data->lastItem()}}  of {{ $department_data->total()}} entries</span>
                                </div>
                                <div class="col-md-6">
