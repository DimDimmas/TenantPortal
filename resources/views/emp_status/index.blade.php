@extends('layouts.moa_main')
    ...
    @section('title')
        <title>MOA | Employee Status</title>
    @endsection
                        ...
                        <div class="iq-card">
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="user-list-table" class="table table-hover table-bordered mt-4" role="grid" aria-describedby="user-list-page-info">
                                    ...
                                    <tbody>
                                            ...
                                            @foreach($emp_status_data as $key => $emp_status)
                                                <tr>
                                                    <td>{{ $emp_status_data->firstItem() + $key }}</td>
                                                    <td>{{ ucfirst($emp_status -> name)}}</td>
                                                    <td>{{ ($emp_status -> status_cd)}}</td>
                                                    <td>
                            ...
                            <div class="row justify-content-between mt-3">
                                <div id="user-list-page-info" class="col-md-6">
                                    <span>Showing {{$emp_status_data->firstItem()}} to {{$emp_status_data->lastItem()}}  of {{ $emp_status_data->total()}} entries</span>
                                </div>
                                <div class="col-md-6">
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination justify-content-end mb-0">
                                            <li >
                                                {{ $emp_status_data->links() }}
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
