...
@else
    ...
    <div class="col-sm-6 col-md-6 col-xs-6">
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                ...
                <h4 class="card-title"><b>Form Complaint</b></h4>
                </div>
            </div>
            <hr>
            ...
            <div class="table-responsive center">
                <div class="col-md-12">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="ticket_no" value="{{ $code }}" readonly>
                        </div>               
                    </div>                         
                    <div class="mb-3 row">
                        <label class="col-sm-2 col-form-label">Status</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="status" value="{{ $list->status_name }}" readonly>
                        </div>               
                    </div>                                
                    <div class="mb-3 row">
                        <label class="col-sm-2 col-form-label">Contact Person</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="person" value="{{ $list->tenant_person }}" readonly>
                        </div>               
                    </div>  
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="date" value="{{ \Carbon\Carbon::parse($list->tenant_ticket_post)->format('d/m/Y')}}" disabled>
                        </div>               
                    </div>
                    <div class="mb-5 row">
    ...
    <div class="col-sm-6 col-md-6 col-xs-6">
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                <h4 class="card-title"><b>Form Response</b></h4>
                </div>
            </div>
            <hr>
                ...
                <div class="col-md-12">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            @endif
                            {{-- @if ($list->status_name == 'New')
                                value="@foreach ($get_spv as $get_spv) {{ $get_spv->engineer_username }}, @endforeach"
                            @else
                                @if (!$get_engineer->isEmpty())
                                    value="@foreach ($get_engineer as $get_engineer) {{ $get_engineer->engineering_username }}, @endforeach"
                                @elseif($get_engineer->isEmpty())
                                    value="@foreach ($get_engineer_2 as $get_engineer) {{ $get_engineer->engineer_username }}, @endforeach"
                                @endif
                            @endif --}}
                            disabled>
                        </div>               
                                ...
                                <ul class="iq-timeline">
                                    @forelse ($activity as $item)
                                        <li>
                                            ...
                                            <h6 class="float-left mb-1">{{ $item->description }}</h6>
                                            <small class="float-right mt-1">{{ $item->engineering_username }}<br>{{ $item->time_taken }} | {{ \Carbon\Carbon::parse($item->created_date)->format('d/m/Y') }}</small>
