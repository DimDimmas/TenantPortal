                        ...
                        <div class="iq-card">
                                    ...
                                    <tbody>
                                            ...
                                            @foreach($project_data as $key => $project)
                                                <tr>
                                                    ...
                                                    <td>{{ $project -> entity -> entity_cd}}</td>
                                                    <td>{{ $project -> project_cd}}</td>
                                                    <td>{{ $project -> proj_type_cd}}</td>
                                                    <td>{{ $project -> description}}</td>
                                                    <td>{{ $project -> location}}</td>
                                            	    <td>{{ $project -> address1}}</td>
                                            	    <td>{{ $project -> address2}}</td>
                                            	    <td>{{ $project -> indocity-> name }}</td>
                            ...
                            <div class="row justify-content-between mt-3">
                                <div id="user-list-page-info" class="col-md-6">
                                    <span>Showing {{$project_data->firstItem()}} to {{$project_data->lastItem()}}  of {{ $project_data->total()}} entries</span>
                                </div>
                                <div class="col-md-6">
